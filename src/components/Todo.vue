...
<template>
  <div class="todo-container">
    ...
    <!-- Main Content Section with blue background -->
...
.header-section {
  background-color: rgb(203, 222, 228); /* Light blue background for header */
  border-bottom: 2px solid blue; /* Blue border at the bottom of the header */
}

.main-content-section {
  background-color: rgb(104, 104, 154); /* Blue background for main content */
...
td {
  ...
  font-size: 12px;
  color: #fff;
  border-bottom: solid 1px rgba(255, 255, 255, 0.016);
}
